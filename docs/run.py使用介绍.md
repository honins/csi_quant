...
| 命令 | 功能 | 耗时 | 说明 |
|------|------|------|------|
| `d` | 数据获取 | 30-60秒 | 获取最新的中证500和中证1000数据 |
| `b` | 基础测试 | 30-90秒 | 验证系统基本功能 |
| `ai` | AI优化训练 | 6-12分钟 | 完整的AI模型训练和优化 |
| `s <日期>` | 单日预测 | 30秒 | 预测指定日期是否为相对低点 |
| `r <开始> <结束>` | 滚动回测 | 2-10分钟 | 回测策略历史表现 |
| `opt` | 策略参数优化 | 2-10分钟 | 优化策略参数 |
| `a` | AI测试 | 2-5分钟 | AI测试和验证 |
| `t` | 单元测试 | 1-3分钟 | 运行所有测试用例 |
| `all` | 全面测试 | 10-20分钟 | 运行完整的系统测试 |
